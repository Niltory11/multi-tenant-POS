    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link <?= $page == 'profit.php' ? 'active':''; ?>" href="profit.php">
                    <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                    Profit
                </a>
                ...
                <div class="collapse <?= ($page == 'products-create.php') || ($page == 'products.php') ? 'show':''; ?>" id="collapseProduct" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?= $page == 'products-create.php' ? 'active':''; ?>" href="products-create.php">Add Product</a>
                        <a class="nav-link <?= $page == 'products.php' ? 'active':''; ?>" href="products.php">View Products</a>


                        <a class="nav-link <?= $page == 'products.php' ? 'active':''; ?>" href="view-products.php">Stock in History</a>
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseExpenses" aria-expanded="false" aria-controls="collapseExpenses">
                            ...
                            <div class="collapse" id="collapseExpenses" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-expenses.php">Add Salesman Expenses</a>
                                    <a class="nav-link" href="addManagerExp.php">Add Manager Expenses</a>



                                    <a class="nav-link" href="view-expenses.php">View Expenses</a>
                                </nav>
                            </div>
