                    ...
                    <table class="table table-striped table-bordered align-items-center justify-content-center" id="ordersTable">
                        ...
                        <tbody>
                            <?php foreach($orders as $orderItem) : ?>
                                <tr 
                                    ...
                                    data-total-due="<?= $orderItem['total_due']; ?>" <!-- Add data attribute for due -->
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th id="totalDue">0.00</th> <!-- New Total Due Footer -->
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const totalDueElement = document.getElementById('totalDue'); // New element for total due

        function calculateTotals() {
            let totalSale = 0;
            let totalDue = 0; // New variable to calculate total due
            ...
            totalDueElement.textContent = totalDue.toFixed(2); // Update total due in the footer
        }
